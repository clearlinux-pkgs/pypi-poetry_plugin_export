...
Source0  : https://files.pythonhosted.org/packages/af/ba/17455f3fb81eb2518f3d52c85de0b3c36a9d5111cf24bf4968aa900260cc/poetry-plugin-export-1.0.7.tar.gz
...
%prep
%setup -q -n poetry-plugin-export-1.0.7
cd %{_builddir}/poetry-plugin-export-1.0.7
pushd ..
cp -a poetry-plugin-export-1.0.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663601010
