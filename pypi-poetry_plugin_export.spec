...
Source0  : https://files.pythonhosted.org/packages/81/bf/270ef984c6f4b610a22a6948096b6b9d949de8f77c4c427d981c530ac521/poetry_plugin_export-1.8.0.tar.gz
...
%prep
%setup -q -n poetry_plugin_export-1.8.0
cd %{_builddir}/poetry_plugin_export-1.8.0
pushd ..
cp -a poetry_plugin_export-1.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715621990
