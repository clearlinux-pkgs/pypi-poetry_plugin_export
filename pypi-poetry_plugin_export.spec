...
%prep
%setup -q -n poetry_plugin_export-1.2.0
cd %{_builddir}/poetry_plugin_export-1.2.0
pushd ..
cp -a poetry_plugin_export-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667844247
