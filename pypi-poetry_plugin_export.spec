...
Source0  : https://files.pythonhosted.org/packages/c4/36/0beed6661369e86447f3550d1d5df529591e046583079dffac10dc86ed21/poetry_plugin_export-1.6.0.tar.gz
...
%prep
%setup -q -n poetry_plugin_export-1.6.0
cd %{_builddir}/poetry_plugin_export-1.6.0
pushd ..
cp -a poetry_plugin_export-1.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698700072
