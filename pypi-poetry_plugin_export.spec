...
Source0  : https://files.pythonhosted.org/packages/68/d8/b3320a09e3051d3cc9c3e47bccb50bc3cb651de88ce8434e61d231ff041d/poetry_plugin_export-1.7.1.tar.gz
...
%prep
%setup -q -n poetry_plugin_export-1.7.1
cd %{_builddir}/poetry_plugin_export-1.7.1
pushd ..
cp -a poetry_plugin_export-1.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710947257
